...
public class TriangleTests 
{
	...
	public void testGetNormal() {
		...
		assertEquals("Test fails, the normal of the triangle is not normalized", 1, triangle.getNormal(point1).length(),
				0.000001);
	...
	public void testFindIntsersections() {
		...
		List<Point3D> point3DList1 = triangle.findIntersections(ray1);
		...
		assertTrue("The test failed, the function did not find what it was looking for",
				point3DList1.get(0).equals(new Point3D(0.5, 0.75, 0)));
		// ============ Equivalence Partitions Tests ==============
		// Ray outside and against edge(zela)
		Ray ray2 = new Ray(point5, vector1);
		List<Point3D> point3DList2 = triangle.findIntersections(ray2);
		...
		List<Point3D> point3DList3 = triangle.findIntersections(ray3);
		...
		List<Point3D> point3DList4 = triangle.findIntersections(ray4);
		...
		List<Point3D> point3DList5 = triangle.findIntersections(ray5);
		...
		List<Point3D> point3DList6 = triangle.findIntersections(ray6);
